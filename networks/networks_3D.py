...
from networks.Capsules import *
from networks.GAB import *
...
class scSERDUNet(nn.Module):
    ...
    def forward(self, x, opts_drop):
        ...
        down4 = F.avg_pool3d(SE3, 2)  # [64,2]

        RDB4 = self.RDB4(down4)
        SE4 = self.SE4(RDB4)  # [64, 2]
        ...
        # decode
        up3 = self.up3(SE4)  # [64, 4]

        RDB_up3 = self.RDB_up3(up3 + SE3)
        SE_up3 = self.SE_up3(RDB_up3)  # [64, 4]
        up2 = self.up2(SE_up3)  # [64, 8]
...
class DenseUNet(nn.Module):
    def __init__(self, n_channels=1, n_filters=32, n_denselayer=6, growth_rate=32):  # suppose n_filters = growrate
